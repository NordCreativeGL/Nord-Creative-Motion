...
export default function ServicesSection() {
  ...
  return (
    <div id="services" ref={sectionRef} style={{ height: "400vh" }}>
      ...
      >
        <div className="max-w-7xl 2xl:max-w-[1700px] mx-auto px-6 2xl:px-16 w-full grid grid-cols-2 gap-16 2xl:gap-24 items-center h-full">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl 2xl:text-[clamp(48px,3vw,68px)] font-light text-white mb-4 leading-tight">
              <div ref={line1Ref}>Visual work for brands,</div>
              <div ref={line2Ref}>companies and projects</div>
            </h2>
            <div ref={accentRef} className="text-xl 2xl:text-[clamp(20px,1.3vw,28px)] text-white/40 font-light mb-8">
              — with a story to tell or a product to sell
            </div>
            <div ref={bodyRef} className="text-lg 2xl:text-[clamp(18px,1.2vw,26px)] text-white/60 leading-relaxed">
            ...
            <div style={{ position: "relative", width: CARD_W, height: `calc(${CARD_H} + 44px)`, marginTop: "48px" }}>
              ...
              >
                ...
                <div style={{
                  ...
                  <p className="text-white text-xl 2xl:text-[clamp(20px,1.3vw,28px)] font-light mb-1">{services[0].title}</p>
              ...
              >
                ...
                <div style={{
                  ...
                  <p className="text-white text-xl 2xl:text-[clamp(20px,1.3vw,28px)] font-light mb-1">{services[1].title}</p>
              ...
              >
                ...
                <div style={{
                  ...
                  <p className="text-white text-xl 2xl:text-[clamp(20px,1.3vw,28px)] font-light mb-1">{services[2].title}</p>
