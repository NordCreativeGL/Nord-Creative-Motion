  ...
  return (
    ...
    >
      ...
      <div style={{ flex: '0 0 50%', display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: 'clamp(160px, 16vw, 220px)', paddingRight: '1rem', zIndex: 2, transform: 'translateX(150px)' }}>
        ...
        <div ref={heading2Ref} style={{ fontSize: 'clamp(34px, 4.2vw, 53px)', fontWeight: 300, lineHeight: 1.05, color: '#ffffff', letterSpacing: '-0.02em', marginBottom: '2rem', display: 'block', textAlign: 'right', width: '100%' }}>We work here</div>
