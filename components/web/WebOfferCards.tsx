...
export default function WebOfferCards() {
  ...
  const titleStyle: React.CSSProperties = { margin: '26px 0 0', fontSize: 13, letterSpacing: '.16em', fontWeight: 600, color: '#eef2f4' }
  const descStyle: React.CSSProperties = { margin: '12px 0 0', fontSize: 14, lineHeight: 1.5, color: 'rgba(238,242,244,.5)' }
