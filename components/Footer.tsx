...
export default function Footer() {
  return (
    <footer id="footer" data-snap="true" className="border-t border-white/10 py-16 bg-black min-h-[25vh] flex flex-col justify-center" style={{ position: 'relative', zIndex: 2 }}>
