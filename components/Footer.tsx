...
export default function Footer() {
  ...
  return (
    <footer id="footer" data-snap="true" className="border-t border-white/10 pt-6 pb-16 min-h-[25vh] flex flex-col justify-center" style={{ position: 'relative', background: 'transparent', zIndex: 6 }}>
