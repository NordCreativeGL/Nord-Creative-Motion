    ...
    >
      ...
      >
        <div className="max-w-7xl min-[1900px]:max-w-[1700px] mx-auto px-6 min-[1900px]:px-16">
          ...
          <h1 style={{ fontSize: isMobile ? 'clamp(20px, 6vw, 26px)' : 'clamp(36px, 3.5vw, 80px)', fontWeight: 300, letterSpacing: '.04em', textTransform: 'uppercase', color: 'white', margin: '0 auto', marginBottom: '10px', maxWidth: isMobile ? '95vw' : '900px', whiteSpace: 'normal', textAlign: 'center' }}>{t[lang].heading}</h1>
