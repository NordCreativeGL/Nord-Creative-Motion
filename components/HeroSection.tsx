...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      .to([oGroupRef.current, needleGroupRef.current], {
        x: 0,
        y: 0,
        scale: 1,
        duration: 1.2,
