...
export default function About() {
  ...
  const t = {
    ...
    da: {
      ...
      p1: 'Inden Nord Creative havde vi forskellige karrierer — Oskar som politibetjent, Johanna i ejendomsbranchen — og en voksende interesse for fotografering og video som en måde at dokumentere det, vi oplevede.',
