    ...
    <main className="min-h-screen text-white">
      ...
      <section id="about-hero" data-snap="true" className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 pb-20">
          ...
          <h1 className="text-[clamp(20px,6vw,26px)] whitespace-nowrap md:text-6xl md:whitespace-normal min-[1900px]:text-[clamp(28px,2.78vw,68px)] font-light text-white uppercase tracking-[0.04em]">{t[lang].heroH1}</h1>
        </div>
      </section>
      ...
      <section id="about-text" data-snap="true" className="bg-black py-24">
        <div className="max-w-7xl min-[1900px]:max-w-[1700px] mx-auto px-6 min-[1900px]:px-16 w-full" style={isMedium ? { maxWidth: 'calc(100vw - 480px)' } : undefined}>
          ...
          <div className="columns-1 min-[1024px]:columns-2 gap-x-16 min-[1900px]:gap-x-24">
            <p className="text-white/60 leading-relaxed mb-6" style={{ fontSize: 'clamp(1.125rem,1.15vw,1.5rem)' }}>{t[lang].p1}</p>
            <p className="text-white/60 leading-relaxed mb-6" style={{ fontSize: 'clamp(1.125rem,1.15vw,1.5rem)' }}>{t[lang].p2}</p>
            <p className="text-white/60 leading-relaxed mb-6" style={{ fontSize: 'clamp(1.125rem,1.15vw,1.5rem)' }}>{t[lang].p3}</p>
          ...
          <div className="relative rounded-2xl overflow-hidden aspect-[16/7] bg-zinc-900 max-[1024px]:aspect-auto max-[1024px]:min-h-[340px]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-11 py-5 rounded-lg border text-white text-[17px] bg-transparent transition-shadow duration-200"
                style={{
                  textTransform: 'none',
                  ...
                  boxShadow: ctaBtnHover ? 'inset 0 1px 0 rgba(255,255,255,.2), 0 0 70px rgba(255,255,255,.32)' : 'inset 0 1px 0 rgba(255,255,255,.14)',
                }}
              >
                {t[lang].ctaBtn}
              </button>
