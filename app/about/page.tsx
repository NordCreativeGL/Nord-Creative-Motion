  ...
  return (
    <main className="min-h-screen text-white">
      ...
      <section id="about-text" data-snap="true" className="bg-black min-h-screen flex items-center">
        <div className="max-w-7xl min-[1900px]:max-w-[1700px] mx-auto px-6 min-[1900px]:px-16 py-16 grid grid-cols-1 min-[1024px]:grid-cols-2 gap-16 min-[1900px]:gap-24 items-center w-full" style={isMedium ? { maxWidth: 'calc(100vw - 520px)' } : undefined}>
