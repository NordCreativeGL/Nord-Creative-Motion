...
export default function FjordHeroScene() {
  useEffect(() => {
    ...
    function buildIceberg(): THREE.Group {
      ...
      const keelMat = new T.MeshStandardMaterial({ vertexColors: true, flatShading: true, roughness: 0.9, metalness: 0, transparent: true, opacity: 0.82, depthWrite: false, side: T.DoubleSide })
      const keelGeo = (() => {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', background: '#081826', fontFamily: "'IBM Plex Mono', monospace" }}>
