      ...
      <div id="fj-copy" style={{ position: 'absolute', left: 0, right: 0, top: '14%', zIndex: 4, pointerEvents: 'none', opacity: 0, transition: 'opacity 0.6s ease' }}>
        <div id="fj-sec-0" style={{ position: 'absolute', left: 0, right: 0, top: 0, textAlign: 'center', padding: '0 6%', opacity: 1, willChange: 'opacity, transform' }}>
          <div style={{ width: 'fit-content', maxWidth: '86vw', margin: '0 auto', padding: 'clamp(18px, 2vw, 28px) clamp(22px, 2.4vw, 36px)' }}>
            <h1 style={{ fontFamily: "var(--font-geist-sans), sans-serif", fontWeight: 300, fontSize: 'clamp(36px,3.5vw,80px)', lineHeight: 1.05, letterSpacing: '.04em', textTransform: 'uppercase', color: '#f4fbff', margin: 0, whiteSpace: 'pre-line' }}>{isMobile ? t[lang].s1hMobile : t[lang].s1h}</h1>
        ...
        <div id="fj-sec-1" style={{ position: 'absolute', left: 0, right: 0, top: 0, textAlign: 'center', padding: '0 6%', opacity: 0, willChange: 'opacity, transform' }}>
          <div style={{ width: 'fit-content', maxWidth: '86vw', margin: '0 auto', padding: 'clamp(18px, 2vw, 28px) clamp(22px, 2.4vw, 36px)' }}>
            <h2 style={{ fontFamily: "var(--font-geist-sans), sans-serif", fontWeight: 300, fontSize: 'clamp(36px,3.5vw,80px)', lineHeight: 1.06, letterSpacing: '.04em', textTransform: 'uppercase', color: '#f4fbff', margin: 0 }}>{t[lang].s2h}</h2>
        ...
        <div id="fj-sec-2" style={{ position: 'absolute', left: 0, right: 0, top: 0, textAlign: 'center', padding: '0 6%', opacity: 0, willChange: 'opacity, transform' }}>
          <div style={{ width: 'fit-content', maxWidth: '86vw', margin: '0 auto', padding: 'clamp(18px, 2vw, 28px) clamp(22px, 2.4vw, 36px)' }}>
            <h2 style={{ fontFamily: "var(--font-geist-sans), sans-serif", fontWeight: 300, fontSize: 'clamp(36px,3.5vw,80px)', lineHeight: 1.06, letterSpacing: '.04em', textTransform: 'uppercase', color: '#f4fbff', margin: 0 }}>{t[lang].s3h}</h2>
